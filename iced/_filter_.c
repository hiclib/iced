 ...
 */
    ...
    __pyx_t_13 = ((*__Pyx_BufPtrStrided1d(__pyx_t_4iced_8_filter__BOOL *, __pyx_pybuffernd_bias.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_bias.diminfo[0].strides)) != 0);
    __pyx_t_11 = __pyx_t_13;
